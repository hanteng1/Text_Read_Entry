...
/**
 * Created by hanteng on 2017-07-20.
 */

public class TestSinglePageRender extends TestPageRender {


    public TestSinglePageRender(Context context, PageFlip pageFlip,
    ...
    public void onDrawFrame() {
        //this is called when there are changes of the interface to render
